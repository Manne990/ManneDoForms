...
namespace ManneDoForms.Components.RangeSliderView
{
	public class ManneRangeSliderView : AbsoluteLayout
	{
		...
		protected override void OnPropertyChanged(string propertyName)
		{
			...
			if(propertyName == ManneRangeSliderView.MinValueProperty.PropertyName ||
				propertyName == ManneRangeSliderView.MaxValueProperty.PropertyName ||
				propertyName == ManneRangeSliderView.LeftValueProperty.PropertyName ||
				propertyName == ManneRangeSliderView.RightValueProperty.PropertyName ||
				propertyName == ManneRangeSliderView.StepProperty.PropertyName)
			{
				UpdateViews();
			}

			if(propertyName == ManneRangeSliderView.LeftValueProperty.PropertyName)
			{
				NotifyLeftValueChanged();
			}

			if(propertyName == ManneRangeSliderView.RightValueProperty.PropertyName)
			{
				NotifyRightValueChanged();
			}

			if(propertyName == ManneRangeSliderView.ShowBubblesProperty.PropertyName)
			{
		...
		public static readonly BindableProperty LeftValueChangedCommandProperty = BindableProperty.Create(nameof(LeftValueChangedCommand), typeof(ICommand), typeof(ManneRangeSliderView), null);
		...
		public static readonly BindableProperty RightValueChangedCommandProperty = BindableProperty.Create(nameof(RightValueChangedCommand), typeof(ICommand), typeof(ManneRangeSliderView), null);
		...
		public static readonly BindableProperty ValueChangeCompletedCommandProperty = BindableProperty.Create(nameof(ValueChangeCompletedCommand), typeof(ICommand), typeof(ManneRangeSliderView), null);
		...
		public static readonly BindableProperty BubbleImageSourceProperty = BindableProperty.Create(nameof(BubbleImageSource), typeof(ImageSource), typeof(ManneRangeSliderView), null);
		...
		[TypeConverter(typeof(ImageSourceConverter))]
		public static readonly BindableProperty HandleImageSourceProperty = BindableProperty.Create(nameof(HandleImageSource), typeof(ImageSource), typeof(ManneRangeSliderView), null);
		...
		public static readonly BindableProperty ActiveBarColorProperty = BindableProperty.Create(nameof(ActiveBarColor), typeof(Color), typeof(ManneRangeSliderView), Color.Black);
		...
		public static readonly BindableProperty InactiveBarColorProperty = BindableProperty.Create(nameof(InactiveBarColor), typeof(Color), typeof(ManneRangeSliderView), Color.Black);
		...
		public static readonly BindableProperty FontFamilyProperty = BindableProperty.Create(nameof(FontFamily), typeof(string), typeof(ManneRangeSliderView), string.Empty);
		...
		public static BindableProperty FontSizeProperty = BindableProperty.Create(nameof(FontSize), typeof(double), typeof(ManneRangeSliderView), 10.0);
		...
		public static BindableProperty TextColorProperty = BindableProperty.Create(nameof(TextColor), typeof(Color), typeof(ManneRangeSliderView), Color.Black);
		...
		public static readonly BindableProperty MinValueProperty = BindableProperty.Create(nameof(MinValue), typeof(double), typeof(ManneRangeSliderView), 0.0);
		...
		public static readonly BindableProperty MaxValueProperty = BindableProperty.Create(nameof(MaxValue), typeof(double), typeof(ManneRangeSliderView), 0.0);
		...
		public static readonly BindableProperty LeftValueProperty = BindableProperty.Create(nameof(LeftValue), typeof(double), typeof(ManneRangeSliderView), 0.0);
		...
		public static readonly BindableProperty RightValueProperty = BindableProperty.Create(nameof(RightValue), typeof(double), typeof(ManneRangeSliderView), 0.0);
		...
		public static readonly BindableProperty StepProperty = BindableProperty.Create(nameof(Step), typeof(double), typeof(ManneRangeSliderView), 0.0);
		public double Step 
		{
		...
		public static readonly BindableProperty ShowBubblesProperty = BindableProperty.Create(nameof(ShowBubbles), typeof(bool), typeof(ManneRangeSliderView), false);
